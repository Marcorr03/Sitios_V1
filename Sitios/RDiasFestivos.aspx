<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RDiasFestivos.aspx.cs" Inherits="Sitios.RDiasFestivos" %>
    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-light bg-transparent">
            ...
            <div class="Arriba">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="32px" viewBox="0 0 512 512"><path d="M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z"/></svg>
                </div>
        </nav>
    </header>
    <div class="Texto">
        <h3 class="text-left">Registro de <br><span class="text">Dias Festivos</span> </h3>
        ...
        <div class="row" id="row">
            ...
            <div class="right">
                <form runat="server">
                    ...
                    <div class="form-group">
                        <label for="Fechadia">Fecha dia Festivo</label>
                        <asp:TextBox type="date" class="form-control" id="Fechadia" required runat="server"></asp:TextBox>
                    </div>
                    <div class="form-group">
                        <label for="Fechacelebra">Fecha que se celebra</label>
                        <asp:TextBox type="date" class="form-control" id="Fechacelebra" required runat="server"></asp:TextBox>
                    </div>
