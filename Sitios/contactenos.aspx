<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="contactenos.aspx.cs" Inherits="Sitios.contactenos" %>
...
<div class="main-content">
    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-light bg-transparent">
            ...
            <div class="Arriba">
                 <a href="iniciosec.aspx" class="navbar-brand">
                 <div class="Usuario">
                    <div class="Usu">
                        <asp:Label  class="mr-2" ID="ROL" runat="server" Text="Label">Iniciar Sesion</asp:Label>
                    </div>
    ...
    <div class="Texto">
        <h3 class="text-left"><br><span class="text">Contactenos</span><br></h3>
    ...
    <section class="approval-form border rounded-lg shadow p-4 position-relative">
        ...
        <div class="row" id="row">
            ...
            <div class="right" style="text-align: center;">
                <br><br>
                <a href="" class="navbar-brand">87236101</a>
                <br>
                <a href="" class="navbar-brand">recursos.cam@gmail.com</a>
                <br>
                <a href="" class="navbar-brand">Habla con KASI</a>
                <br><br>
            </div>
        </div>
    </section>
