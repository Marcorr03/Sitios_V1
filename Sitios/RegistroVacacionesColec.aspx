<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegistroVacacionesColec.aspx.cs" Inherits="Sitios.RegistroVacacionesColec" %>
...
<div class="main-content">
    ...
    <div class="Texto">
        <h3 class="text-left">Registro de <br><span class="text">Vacaciones Colectivas</span> </h3>
            ...
            <div class="right">
                <form runat="server">
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <label for="Estado">Estado</label>
                         <select id="Select1" class="form-control" name="Estado" required runat="server">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="Descripcion" class="form-control" cols="20" rows="2"></textarea>
                    </div>
                    <div class="form-group">
                        <label for="Fechainicio">Fecha Inicio</label>
                        <asp:TextBox type="date" class="form-control" id="Fechainicio" required runat="server"></asp:TextBox>
                    </div>
                    <div class="form-group">
                        <label for="Fechafin">Fecha Fin</label>
                        <asp:TextBox type="date" class="form-control" id="Fechafin" required runat="server"></asp:TextBox>
                    </div>
