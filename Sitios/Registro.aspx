<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Registro.aspx.cs" Inherits="Sitios.Registro" %>
...
<div class="main-content">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-transparent">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"><a class="nav-link" href="#">Permisos</a></li>
                    <li class="nav-item"><a class="nav-link" href="#">Inconsistencias</a></li>
                    <li class="nav-item"><a class="nav-link" href="#">Vacaciones</a></li>
                    <li class="nav-item"><a class="nav-link" href="#">Marcar</a></li>
                </ul>
            </div> 
            <div class="Arriba">
                <div class="Usuario">
                    <div class="Usu">
                         <asp:Label ID="Persona" class="mr-2" runat="server" ><asp:Label style="font-weight: bold;" ID="ROL" runat="server">Jefe</asp:Label> Andrey Jimenez</asp:Label>
                    </div>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="32px" viewBox="0 0 512 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z"/></svg>
                </div>
        </nav>
    </header>
    <div class="Texto">
        <h3 class="text-left">Registro de <br><span class="text">Empleados</span> </h3>
    ...
    <section class="approval-form border rounded-lg shadow p-4 position-relative">
        ...
        <img src="img/jefe.png" alt="Imagen de jefe" class="boss-image">
            ...
            <div class="right">
                <form runat="server">
                    <div class="form-group">
                        ...
                        <asp:TextBox type="text" class="form-control" id="nombre" required runat="server"></asp:TextBox>
                    </div>
                    <div class="form-group">
                        <label for="PriApellido">Primer Apellido</label>
                        <asp:TextBox type="text" class="form-control" id="PriApellido" required runat="server"></asp:TextBox>
                    </div>
                     <div class="form-group">
                         <label for=SegApellido">Segundo Apellido</label>
                         <asp:TextBox type="text" class="form-control" id="SegApellido" required runat="server"></asp:TextBox>
                     </div>
                    <div class="form-group">
                        <label for="Identificacion">Identificacion</label>
                        <asp:TextBox type="text" class="form-control" id="identificacion" required runat="server"></asp:TextBox>
                    </div>
                    <div class="form-group">
                        <label for="Correo">Correo</label>
                        <asp:TextBox type="email" class="form-control" id="correo" required runat="server"></asp:TextBox>
                    </div>
                    <div class="form-group">
                        <label for="telefono">Telefono</label>
                        <asp:TextBox type="text" class="form-control" id="telefono" required runat="server"></asp:TextBox>
                    </div>
                    <div class="form-group">
                        <label for="usuario">Usuario</label>
                        <asp:TextBox type="text" class="form-control" id="usuario" required runat="server"></asp:TextBox>
                    </div>
                    
                     <div class="form-group">
                        <label for="Contraseña">Contraseña</label>
                         <asp:TextBox type="password" class="form-control" id="contra" required runat="server"></asp:TextBox>
                    </div>
                     <div class="form-group">
                        <label for="Estado">Estado</label>
                         <select id="Estado" class="form-control" name="Estado" required runat="server">
                    ...
                    <div class="form-group">
                       <label for="Rol">Rol</label>
                            <select id="Rol_" class="form-control" name="Rol_" required runat="server"></select>
                    </div>
                    <div class="form-group s">
                        <asp:Button ID="AGREGAR" runat="server" type="submit" class="btn btn-primary" Text="AGREGAR" OnClick="AGREGAR_Click"/>
                    </div>
                </form>
            </div>
        </div>
